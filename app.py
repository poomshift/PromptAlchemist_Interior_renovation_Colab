...
with gr.Blocks(title="Exterior and Interior Renovation Ai") as demo:
    gr.Markdown("""# Exterior and Interior Renovation Ai""")   
    gr.Markdown("โปรแกรมรีโนเวทบ้านและห้องด้วย Ai | fb.com/PromptAlchemist")  
    with gr.Row():
